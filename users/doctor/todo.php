                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            ...
                            <div class="card cards card-2 " style="width: auto;">
                                <a href="">
                                    <div class="card-body">
                                        <h5 class="card-title text-center">Nurses Need to See</h5>
                                        <p class="card-text">
                                                <?php
                                    ...
                                    <div class="card-body">
                                        ...
                                        <p>
                                            <?php
                                                ...
                                                $sql = "SELECT procedures.procedure_name, procedures.procedure_time, procedures.procedure_date, procedures.procedure_desc, operating_rooms.operating_room_name
                                                        FROM procedures 
                                                ...
                                                <?php
                                                    ...
                                                    echo "<div class='alert alert-info mt-5'>No Procedures Yet</div>";
                                                }
                                            ?>
                                        </p>
                                    </div>
